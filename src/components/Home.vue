...
import { Controller, Mousewheel, FreeMode } from "swiper";
import "swiper/css";
...
const setThirdSwiper = (swiper) => {
  thirdSwiper.value = swiper;
};
const setFourthSwiper = (swiper) => {
